...
internal fun PtzCameraControls(
    ...
    var movementSpeed by remember { mutableFloatStateOf(DEFAULT_MOVEMENT_SPEED) }
...
private fun PanTiltJoystick(
    ...
    Box(
        ...
        Canvas(modifier = Modifier.fillMaxSize()) {
            ...
            drawLine(
                arrowColor,
                center.copy(y = 19.dp.toPx()),
                center.copy(y = 34.dp.toPx()),
                2.dp.toPx(),
                StrokeCap.Round,
            )
            drawLine(
                arrowColor,
                center.copy(y = size.height - 19.dp.toPx()),
                center.copy(y = size.height - 34.dp.toPx()),
                2.dp.toPx(),
                StrokeCap.Round,
            )
            drawLine(
                arrowColor,
                center.copy(x = 19.dp.toPx()),
                center.copy(x = 34.dp.toPx()),
                2.dp.toPx(),
                StrokeCap.Round,
            )
            drawLine(
                arrowColor,
                center.copy(x = size.width - 19.dp.toPx()),
                center.copy(x = size.width - 34.dp.toPx()),
                2.dp.toPx(),
                StrokeCap.Round,
            )
            drawCircle(
...
private fun limitedJoystickOffset(
    offset: Offset,
    maxDistance: Float,
): Offset {
