        ...
        Column(
            ...
            Column(modifier = Modifier.padding(horizontal = 20.dp, vertical = 12.dp)) {
                ...
                when (updateState.status) {
                    UpdateStatus.AVAILABLE -> Button(onClick = onDownloadUpdate) {
                        Text("Download update")
                    }
                    UpdateStatus.READY -> Button(
                        onClick = {
                    ...
                    UpdateStatus.ERROR -> TextButton(onClick = onCheckForUpdates) {
...
private fun installUpdate(context: android.content.Context, path: String) {
